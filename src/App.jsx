  ...
  return React.createElement("div",null,
    ...
    React.createElement("div",{style:{padding:"16px 16px 0"},className:"wrap"},
      React.createElement("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(180px,1fr))",gap:12,marginBottom:16}},
        [["Today",todayB.length,B,"cal","diary"],["Upcoming",upcoming,SK,"award","diary"],["Students",stus.length,GR,"user","students"],["Exams",exams.length,GD,"trophy","diary"]].map(function(row){ return React.createElement("div",{key:row[0],onClick:function(){ go(row[4]); },style:{background:"#fff",borderRadius:16,padding:16,boxShadow:"0 2px 12px rgba(0,0,0,0.06)",cursor:"pointer"}},React.createElement("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}},React.createElement("div",{style:{fontFamily:"'Plus Jakarta Sans',sans-serif",fontSize:28,fontWeight:800,color:row[2]}},row[1]),React.createElement("div",{style:{width:36,height:36,borderRadius:10,background:row[2]+"15",display:"flex",alignItems:"center",justifyContent:"center"}},React.createElement(Ico,{n:row[3],sz:18,c:row[2]}))),React.createElement("div",{style:{fontSize:12,color:MT,marginTop:4,fontWeight:600}},row[0])); })
      ),
