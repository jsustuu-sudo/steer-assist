...
function RevPage(props) {
  ...
  return React.createElement("div",null,
    React.createElement("div",{style:{background:"linear-gradient(160deg,"+NV+","+BL+")",padding:"20px 20px 28px",color:"#fff"}},
      ...
      React.createElement("div",{className:"wrap",style:{display:"flex",alignItems:"center",gap:16}},React.createElement("div",{style:{fontFamily:"'Plus Jakarta Sans',sans-serif",fontSize:52,fontWeight:800,color:"#fff",lineHeight:1}},"5.0"),React.createElement("div",null,React.createElement("div",{style:{color:GD,fontSize:24}},"\u2605\u2605\u2605\u2605\u2605"),React.createElement("a",{href:"https://www.google.com/search?sca_esv=aa30526fefaab2aa&hl=en-GB&gl=uk&sxsrf=ANbL-n4oyfvtk2LhGu6-MAEz6_7viPg0PQ:1777905999105&si=AL3DRZEsmMGCryMMFSHJ3StBhOdZ2-6yYkXd_doETEE1OR-qOfVc1G2WCvsw-d-Wt1bPCQWS7TYcd_tEp0U7gJ1-ranCLyPjfHBJ8ZgJTAwmV9rdOjJt9X2AOas6FVEGApimKZ0OeTx0w3G84u7LIqOiIuMI06ijrA%3D%3D&q=Steer+Assist+Driving+School+Reviews&sa=X&ved=2ahUKEwj-9JT875-UAxVPbqQEHTmUBdUQ0bkNegQIJRAF&cshid=1777906043820794&biw=2043&bih=928&dpr=2",target:"_blank",rel:"noopener noreferrer",style:{fontSize:12,opacity:0.7,marginTop:4,color:"#fff",textDecoration:"underline"}},"1,014 Google Reviews")))
    ),
    React.createElement("div",{style:{padding:16},className:"wrap"},
